...
//  app.nillicous
//
//  Created by Ali Ghayeni on 7/17/16.
...
class NewsChild: BaseAdapter{
    ...
    @IBOutlet weak var newsDatePublished: UILabel!
    @IBOutlet weak var newsRelatedR: UILabel!
    ...
    @IBAction func showRelatedRestaurants(_ sender: AnyObject) {
...
//    }
    ...
    override func viewDidLoad() {
      ...
      let newsId = UserDefaults.standard.object(forKey: "newsId") as! String
        
        
        self.getNews(newsId)
        
        newsTime.layer.cornerRadius = 5
        newsTime.layer.masksToBounds = true

        newsDatePublished.layer.cornerRadius = 5
        newsDatePublished.layer.masksToBounds = true
                ...
                DispatchQueue.main.async {
                    ...
                    if isDataAvailable {
                        ...
                        var data  = self.newsArrayDic[0]
                               ...
                               self.newsDatePublished.text = data["create"]!
                               self.newsTime.text = " ساعت " + component().changeFormat(data["time"]!)
                               self.nDate = "تاریخ انتشار : " + data["create"]! + " ساعت " + data["time"]!
                        
                        do{
                            if "1" != data["thumb"] as String! {
                                let imageView = self.newsImage
                                ...
                                self.newsImage.image = UIImage(named: "defaults.jpg")!
                            }
                        }catch{
                            print("image is null!")
                            self.newsImage.image = UIImage(named: "defaults.jpg")!
...
//                        do{
                       ...
                       if  let relation = data["relation"] as String! {
                               if relation.characters.count > 0 {
                                    self.newsRelatedR.text = "مرتبط با " //+ data["nRelationName"]!
