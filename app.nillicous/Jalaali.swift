...
//  com.eatamin
//
//  Created by Ali Ghayeni on 12/19/16.
...
public func toJalaali(gy: GregorianYear, gm: GregorianMonth, gd: GregorianDay) -> JalaaliDate {
    return toJalaali(gy: gy, gm: gm, gd: gd)
}

/// Converts a Gregorian date to Jalaali.
public func toJalaali1(gy: GregorianYear, gm: GregorianMonth, gd: GregorianDay) -> JalaaliDate {
...
public func toGregorian(jy: JalaaliYear, jm: JalaaliMonth, jd: JalaaliDay) -> GregorianDate {
    return toGregorian(jy: jy, jm: jm, jd: jd)
}

/// Converts a Jalaali date to Gregorian.
public func toGregorian1(jy: JalaaliYear, jm: JalaaliMonth, jd: JalaaliDay) -> GregorianDate {
...
public func isValidJalaaliDate(jy: JalaaliYear, jm: JalaaliMonth, jd: JalaaliDay) -> Bool {
    return isValidJalaaliDate(jy: jy, jm: jm, jd: jd)
}

/// Checks whether a Jalaali date is valid or not.
public func isValidJalaaliDate1(jy: JalaaliYear, jm: JalaaliMonth, jd: JalaaliDay) -> Bool {
...
public func lastDayOfJalaaliMonth(jy: JalaaliYear, jm: JalaaliMonth) -> JalaaliDay {
    return lastDayOfJalaaliMonth(jy: jy, jm: jm)
}

/// Number of days in a given month in a Jalaali year.
public func lastDayOfJalaaliMonth1(jy: JalaaliYear, jm: JalaaliMonth) -> JalaaliDay {
    if jm <= 6 { return 31 }
    if jm <= 11 { return 30 }
